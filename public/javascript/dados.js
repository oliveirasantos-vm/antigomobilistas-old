$(document).ready(() => {
    ...
    $("#confirm").click(function() {
        ...
        form.attr("action", "/usuario/remover");

        var field = $('<input></input>');

        field.attr("type", "hidden");
        field.attr("name", "iduser");
        field.attr("value", $("#iduser").val());
    ...
    $("#change-avatar-button").mouseover(() => {
        $("#img-preview-block").css('position', "relative");
        $("#img-preview-block").css('background-color', "#000");
        $("#img-preview-block").css('opacity', "0.5");
    });
    $("#change-avatar-button").mouseout(() => {
        $("#img-preview-block").css('position', "relative");
        $("#img-preview-block").css('background-color', "none");
        $("#img-preview-block").css('opacity', "1");
    });
